...
public class Step2IndirectParticipant {
    ...
    public static Step2IndirectParticipant getInstance(String line) {
        return new Step2IndirectParticipant(line.substring(0, 11),
                line.substring(11,61),
                ...
                line.substring(77,85),
                line.substring(85,96),
                line.substring(96,97)
        );
    }
    
    public SepaDirectoryItem getDirectoryItem() {
        return new SepaDirectoryItem(participantBic, participantName, 4, validFrom,validTo, null);        
    }
